...
const API_BASE_URL = 'https://atlas.smartgeoapps.com/MRVAPI/api/Role'; // INPUT_REQUIRED {API_BASE_URL is the base URL for the roles API. Replace localhost:5259 with your actual API host and port if different.}
