        ...
        <div data-simplebar>
          <ul className="app-menu">
            ...
            <li class="menu-item">
              ...
              >
                <span className="menu-icon">
                  <BsLayoutTextSidebarReverse color="#cedce4" />{" "}
            ...
            <li class="menu-item">
              ...
              >
                <span className="menu-icon">
                  <AiOutlineAppstore color="#cedce4" />{" "}
                  {/* Apply color as needed */}
                </span>
