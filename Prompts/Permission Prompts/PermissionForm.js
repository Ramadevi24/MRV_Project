1. **View Permission Page**:
    - When clicking the **View** icon in the Permission grid, navigate to a "View Permission" page.
    - The "View Permission" page should display all the Permission's details ( - Permission ID
        - permissionDisplayName
        - description
        - permissionuniquename
        - permissionGroup) in a grid table**.
...
3. **API Integration**:
    - Use `axios` for making API calls to edit Permissions.
       - The list of Permissions for the grid page should be fetched from an API.
